...
\input{./Otros/enunciado_viajante.tex}

\subsection{Vecino más cercano}
\input{./Otros/memoria_vecino_mas_cercano.tex}

\subsection{Inserción}
%input{./Otros/....tex}

\subsection{Arista más corta}
\input{./Otros/memoria_arista_corta.tex}

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
%					 Bibliografia
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
\section{Bibliografia}
\input{./Otros/bibliografia.tex}
\newpage
