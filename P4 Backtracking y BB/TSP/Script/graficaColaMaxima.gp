...
plot "../DatosGraficas/colaMaxima.dat" using 2:xticlabels(1) title 'Cola algoritmo x0' ls 1, "../DatosGraficas/colaMaxima.dat" using 3:xticlabels(1) title 'Cola algoritmo x1' ls 2, "../DatosGraficas/colaMaxima.dat" using 4:xticlabels(1) title 'Cola algoritmo x2' ls 3
